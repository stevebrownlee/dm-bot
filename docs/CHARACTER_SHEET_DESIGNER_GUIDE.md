...
This guide explains how to create YAML-based character sheets for AD&D 1st Edition characters. Character sheets are stored in the `character_sheets/` directory as structured YAML files.

## Quick Start

1. Copy `character_sheets/template.yaml` to a new file

...
from dungeon_master.models import GameDependencies, PlayerStats, WorldState, CampaignData, CampaignState

# Database configuration - use project root / data / game-state.sqlite3
# Walk up from this file: persistence/game_state.py -> persistence -> dungeon_master -> src -> project_root
_PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent.parent
DB_PATH = _PROJECT_ROOT / "data" / "game-state.sqlite3"

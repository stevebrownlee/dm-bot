...
from dungeon_master.models import CharacterSheet


class CharacterSheetManager:
    """Manages loading and validation of character sheets from YAML files."""

    def __init__(self, character_sheets_dir: str = "data/character_sheets"):
        """
    ...
    def create_character_from_template(self,
        ...
        """
        from dungeon_master.models import AbilityScores, CharacterSavingThrows, Equipment, CharacterTreasure
